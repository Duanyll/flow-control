...
experiment configs), `data/`, `demo/`, `draft/` are gitignored. Repo layout and
the linear-`main` multi-machine workflow are documented in @docs/repo-layout.md;
run-artifact layout (`runs/`, logs, checkpoints) in @docs/output-layout.md.
